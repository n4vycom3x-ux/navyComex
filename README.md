...
La sección de ubicación muestra el nuevo punto de la oficina de NavyComex en Calle A, Villa Dolores F, sector Franz Tamayo, Distrito 3, El Alto, La Paz. Google Maps identifica el punto con el código Plus `FRH9+F8J` y las coordenadas `-16.521279, -68.181732`.
